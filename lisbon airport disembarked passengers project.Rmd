...
```{r passenger disembarks from 2004 to 2024-08}
...
```{r passenger disembarks from 2004 to 2020-01}
...
```
```{r passenger disembarks from 2004 to 2020-01 ts-display}
...
```{r passenger disembarks from 2004 to 2020-01 decomposition}
...
```{r passenger disembarks from 2004 to 2020-01 BoxCox lambda}
